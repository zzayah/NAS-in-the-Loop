...
This repository is based on the f1 racetrack database which includes
...
that includes both resolution and origin of the maps. These maps can be used in both the F1TENTH Gym and F1TENTH Simulator.
